...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuses = $em->getRepository('BoxBundle:Status')->findAll();
    ...
    {
        $status = new Status();
        $form = $this->createForm('BoxBundle\Form\StatusType', $status);
    ...
    {
        $deleteForm = $this->createDeleteForm($status);
        $editForm = $this->createForm('BoxBundle\Form\StatusType', $status);
